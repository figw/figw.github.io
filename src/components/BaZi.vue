...
<el-col :xs="24" :sm="24" :lg="16" :xl="8">
  ...
  <el-row justify="space-around">
    <el-col :span="2" v-for="i in ['一','二','三','四','五','六','七','八','九','十'].slice(0,daYunList.length)">
      <p class="sml">{{i}}<br />运</p>
    </el-col>
  </el-row>
  <el-row justify="space-around">
    <el-col :span="2" v-for="i in daYunList" :style="getColor(i[0])">
  ...
  <el-row justify="space-around">
    <el-col :span="2" v-for="i in daYunList" :style="getColor(i[1])">
      <p class="nml" style="margin:5px 0">
