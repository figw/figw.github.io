<script setup>
import { ref } from 'vue'
import { CANG_GAN, CHANG_SHENG_MAP, KONG_WANG_MAP, NA_YIN_MAP, SHI_SHEN_MAP, TIAN_GAN, WU_XING_COLOR, WU_XING_MAP, YANG_GAN, YANG_ZHI, YIN_GAN, YIN_ZHI } from '../assets/constant.js'
